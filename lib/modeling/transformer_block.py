...
class Transformer(nn.Module):
    def __init__(self, t_encoder_embed_dim, t_encoder_num_heads, t_encoder_depth, mlp_ratio,
                 norm_layer=nn.LayerNorm, drop=0., attn_drop=0., drop_path=0., qkv_bias=True):
        super().__init__()
    ...
    def forward(self, x, src_key_padding_mask=None, pos=None):
        for blk in self.blocks:
            x = blk(x, src_key_padding_mask, pos)
        return x
