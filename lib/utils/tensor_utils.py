...
if __name__ == '__main__':
    ...
    # pad_seqeunces_2d
    test_data_3d = [torch.randn(2,2,4), torch.randn(4,3,4), torch.randn(1,5,4)]
    print(pad_sequences_2d(test_data_3d, dtype=torch.float)[0].shape)  # padded_seqs 3x4x5x4
    print(pad_sequences_2d(test_data_3d, dtype=torch.float)[1].shape)  # mask 3x4x5
    
    test_data_3d2 = [[torch.randn(2,4), ], [torch.randn(3,4), torch.randn(5,4)]]
    print(pad_sequences_2d(test_data_3d2, dtype=torch.float)[0].shape)  # padded_seqs 2x2x5x4
    print(pad_sequences_2d(test_data_3d2, dtype=torch.float)[1].shape)  # mask 2x2x5
